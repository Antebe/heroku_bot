...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="worker" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" C:\Users\User\IdeaProjects\MinorGame_bott\src\main\java\MainClass.java %CMD_LINE_ARGS%
